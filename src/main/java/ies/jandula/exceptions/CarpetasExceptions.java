package ies.jandula.exceptions;

import java.util.HashMap;
import java.util.Map;

public class CarpetasExceptions extends Exception
{
	/** Atributo - Código */
	private int code ;
	 ...
	 */
	public CarpetasExceptions(int code, String message)
	{
		super(message);
	 ...
	 */
	public CarpetasExceptions(int code, String message, Throwable exception)
	{
